...
var Button = function (props) {
    ...
    return (React__default["default"].createElement("button", __assign({}, buttonProps, { disabled: disabled, className: classnames(styles$f.root, props.className, (_a = {},
...
var Checkbox = function (props) {
    ...
    var _c = React.useState(value), checked = _c[0], setChecked = _c[1];
    var changeHandler = React.useCallback(function (event) {
        if (!disabled) {
    ...
    return (React__default["default"].createElement("label", __assign({}, otherProps, { className: classnames(styles$e.root, otherProps.className) }),
        React__default["default"].createElement("input", { name: name, className: styles$e.input, type: "checkbox", checked: checked, onChange: changeHandler }),
        React__default["default"].createElement("div", { className: classnames(styles$e.checkbox, (_a = {},
...
var Heading = function (props) {
    ...
    switch (type) {
        case "H1+":
            return React__default["default"].createElement("h1", __assign({}, headingProps, { className: classnames(styles$d.root, styles$d.root_H1Plus, headingProps.className) }));
        case "H1":
            return React__default["default"].createElement("h1", __assign({}, headingProps, { className: classnames(styles$d.root, styles$d.root_H1, headingProps.className) }));
        case "H2":
            return React__default["default"].createElement("h2", __assign({}, headingProps, { className: classnames(styles$d.root, headingProps.className) }));
        case "H3":
            return React__default["default"].createElement("h3", __assign({}, headingProps, { className: classnames(styles$d.root, headingProps.className) }));
        case "H4":
            return React__default["default"].createElement("h4", __assign({}, headingProps, { className: classnames(styles$d.root, headingProps.className) }));
        case "H5":
            return React__default["default"].createElement("h5", __assign({}, headingProps, { className: classnames(styles$d.root, headingProps.className) }));
    }
};
...
var IconButton = function (props) {
    ...
    return (React__default["default"].createElement("div", __assign({}, otherProps, { onClick: !disabled ? otherProps.onClick : undefined, className: classnames(styles$c.root, otherProps.className, (_a = {},
...
var Close = function (props) {
    return (React__default["default"].createElement("svg", __assign({ width: "29", height: "29", viewBox: "0 0 29 29", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default["default"].createElement("path", { d: "M14.75 28.5C22.3439 28.5 28.5 22.3439 28.5 14.75C28.5 7.15608 22.3439 1 14.75 1C7.15608 1 1 7.15608 1 14.75C1 22.3439 7.15608 28.5 14.75 28.5Z", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default["default"].createElement("path", { d: "M10.625 10.625L18.875 18.875", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default["default"].createElement("path", { d: "M18.875 10.625L10.625 18.875", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};

var ArrowLeft = function (props) {
    return (React__default["default"].createElement("svg", __assign({ width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default["default"].createElement("path", { d: "M11 5.81812L7 9.81812L11 13.8181", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};

var ArrowRight = function (props) {
    return (React__default["default"].createElement("svg", __assign({ width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default["default"].createElement("path", { d: "M9 14.1819L13 10.1819L9 6.18189", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};

var Add = function (props) {
    return (React__default["default"].createElement("svg", __assign({ width: "47", height: "47", viewBox: "0 0 47 47", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default["default"].createElement("path", { d: "M23.5 46C35.9264 46 46 35.9264 46 23.5C46 11.0736 35.9264 1 23.5 1C11.0736 1 1 11.0736 1 23.5C1 35.9264 11.0736 46 23.5 46Z", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default["default"].createElement("path", { d: "M23.3408 15V33", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default["default"].createElement("path", { d: "M14 24H32.6815", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};
...
var Input = function (props) {
    ...
    return (React__default["default"].createElement("div", { className: classnames(styles$b.root, className, (_a = {}, _a[styles$b.root_large] = size === "large", _a)), style: style },
        startAdornment && React__default["default"].createElement("div", { className: styles$b.startAdornment }, startAdornment),
        React__default["default"].createElement("input", __assign({ type: "text" }, inputProps, { className: styles$b.input })),
        endAdornment && React__default["default"].createElement("div", { className: styles$b.endAdornment }, endAdornment)));
};
Input.defaultProps = {
    size: 'default',
};
...
var Label = function (props) {
    return (React__default["default"].createElement("label", __assign({}, props, { className: classnames(styles$a.root, props.className) })));
};
...
var Navbar = function (props) {
    return (React__default["default"].createElement("nav", __assign({}, props, { className: classnames(styles$8.root, props.className) }), props.children));
};
...
var NavbarItem = function (props) {
    ...
    if (!Component) {
        return React__default["default"].createElement("a", __assign({}, componentProps, { className: styles$7.root }));
    }
    return (React__default["default"].createElement(Component, __assign({}, componentProps, { className: styles$7.root })));
};
...
var Pagination = function (props) {
    ...
    var _a = React.useState(value || 0), page = _a[0], setPage = _a[1];
    var visiblePagesCount = React.useMemo(function () { return maxVisiblePages && maxVisiblePages > 0
        ? Math.min(maxVisiblePages, totalPages)
        : totalPages; }, [maxVisiblePages, totalPages]);
    var pagesArray = React.useMemo(function () { return Array(visiblePagesCount).fill(null); }, [visiblePagesCount]);
    var getChangeHandler = React.useCallback(function (pageIndex) { return function () {
    ...
    var getPageIndex = React.useCallback(function (pageIndex) {
        if (!maxVisiblePages) {
            return pageIndex;
        }
        return pageIndex + Math.floor(page / maxVisiblePages) * maxVisiblePages;
    }, [maxVisiblePages, page]);
    var renderPage = React.useCallback(function (index) {
        var _a;
        var globalIndex = getPageIndex(index);
        var isVisible = globalIndex <= totalPages - 1;
        return (React__default["default"].createElement("div", { key: globalIndex, className: classnames(styles$6.page, (_a = {}, _a[styles$6.page_active] = page === globalIndex, _a)), onClick: isVisible ? getChangeHandler(globalIndex) : undefined, style: { visibility: isVisible ? "visible" : "hidden" } },
            React__default["default"].createElement("div", { className: styles$6.dot })));
    }, [totalPages, getPageIndex, totalPages, page, getChangeHandler]);
    return (React__default["default"].createElement("div", { className: classnames(styles$6.root, className), style: style },
        React__default["default"].createElement(IconButton, { disabled: page === 0, onClick: getChangeHandler(page - 1) },
            React__default["default"].createElement(ArrowLeft, null)),
        pagesArray.map(function (_, index) { return renderPage(index); }),
        React__default["default"].createElement(IconButton, { disabled: page === totalPages - 1, onClick: getChangeHandler(page + 1) },
...
var Paragraph = function (props) {
    ...
    return (React__default["default"].createElement("p", __assign({}, pProps, { className: classnames(styles$5.root, styles$5["root_" + type]) }), pProps.children));
};
...
var Select = function (props) {
    ...
    var getChangeHandler = React.useCallback(function (option) { return function (checked) {
        if (checked) {
    ...
    var toggleMenu = React.useCallback(function (isOpen) {
        setIsOpen(function (prevState) { return isOpen === undefined ? !prevState : isOpen; });
    }, []);
    var outsideClickListener = React.useCallback(function (event) {
        var _a;
    ...
    return (React__default["default"].createElement("div", { className: classnames(styles$4.root, className), onFocus: onFocus, onBlur: onBlur, style: style, ref: wrapperRef },
        React__default["default"].createElement("div", { className: classnames(styles$4.select, (_a = {}, _a[styles$4.select_menuOpen] = isOpen, _a)), onClick: function () { return toggleMenu(); } },
            text,
...
var Tag = function (props) {
    ...
    var isColorInTagColors = React.useMemo(function () { return color && Object.values(TagColor).includes(color); }, [color]);
    var tagColorClassName = React.useMemo(function () { return isColorInTagColors ? styles$3["root_" + color] : undefined; }, [color, isColorInTagColors]);
    var backgroundColor = React.useMemo(function () { return isColorInTagColors ? undefined : color; }, [color, isColorInTagColors]);
    return (React__default["default"].createElement("div", __assign({}, otherProps, { className: classnames(styles$3.root, className, tagColorClassName), style: __assign(__assign({}, style), { backgroundColor: backgroundColor }) }), props.children));
};
Tag.defaultProps = {
    color: "#B09A81",
};
...
var TextArea = function (props) {
    ...
    return (React__default["default"].createElement("div", { className: classnames(styles$2.root, className), style: style },
        React__default["default"].createElement("textarea", __assign({}, textAreaProps, { className: styles$2.textarea }))));
};
...
var ColorPicker = function (props) {
    ...
    var _b = React.useState(value), color = _b[0], setColor = _b[1];
    var changeHandler = React.useCallback(function (event) {
    ...
    return (React__default["default"].createElement(Label, __assign({}, labelProps, { className: classnames(styles$1.root, className) }),
        React__default["default"].createElement("div", { className: styles$1.color, style: { backgroundColor: color } },
            React__default["default"].createElement("input", { type: "color", className: styles$1.input, value: color, onChange: changeHandler })),
        label));
};
...
var ImageUploader = function (props) {
    ...
    var _b = React.useState(value), image = _b[0], setImage = _b[1];
    var _c = React.useState(false), isModalOpen = _c[0], setIsModalOpen = _c[1];
    var _d = React.useState(""), inputValue = _d[0], setInputValue = _d[1];
    var openModal = React.useCallback(function () { return setIsModalOpen(true); }, []);
    var closeModal = React.useCallback(function () { return setIsModalOpen(false); }, []);
    var inputChangeHandler = React.useCallback(function (event) {
        setInputValue(event.target.value);
    }, []);
    var modalSaveButtonClickHandler = React.useCallback(function () {
        setImage(inputValue);
        closeModal();
    }, [inputValue, closeModal]);
    var controlChangeButtonClickHandler = React.useCallback(function () {
        setImage(undefined);
        onChange === null || onChange === void 0 ? void 0 : onChange(undefined);
    }, [onChange]);
    var controlSaveButtonClickHandler = React.useCallback(function () {
        onChange === null || onChange === void 0 ? void 0 : onChange(image);
    }, [onChange]);
    var fileInputChangeHandler = React.useCallback(function (event) {
    ...
    return (React__default["default"].createElement("div", __assign({ className: classnames(styles.root, className) }, otherProps),
        React__default["default"].createElement("div", { className: classnames(styles.container, (_a = {}, _a[styles.container_hasImage] = !!image, _a)), style: containerStyles },
            React__default["default"].createElement("label", { className: styles.addButton },
                React__default["default"].createElement(IconButton, { color: "negative" },
                    React__default["default"].createElement(Add, null)),
                React__default["default"].createElement("input", { className: styles.input, type: "file", accept: "image/*", onChange: fileInputChangeHandler })),
            React__default["default"].createElement(Button, { color: "negative", size: "small", className: styles.urlButton, onClick: openModal }, "URL \u0418\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F"),
            React__default["default"].createElement(Modal, { className: styles.modal, open: isModalOpen, onClose: closeModal },
                React__default["default"].createElement("div", { className: styles.modalContent },
                    React__default["default"].createElement(Label, null,
                        "\u0410\u0434\u0440\u0435\u0441 \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F",
                        React__default["default"].createElement(Input, { type: "url", placeholder: "https://www.example.com", value: inputValue, onChange: inputChangeHandler })),
                    React__default["default"].createElement(Button, { className: styles.modalSaveButton, type: "button", color: "green", size: "default", onClick: modalSaveButtonClickHandler, disabled: !inputValue }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C")))),
        React__default["default"].createElement("div", { className: styles.controls },
            React__default["default"].createElement(Button, { className: styles.controlButton, size: "small", disabled: !image, onClick: controlChangeButtonClickHandler }, "\u0418\u0437\u043C\u0435\u043D\u0438\u0442\u044C"),
            React__default["default"].createElement(Button, { className: styles.controlButton, size: "small", color: "green", disabled: !image, onClick: controlSaveButtonClickHandler }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"))));
};
